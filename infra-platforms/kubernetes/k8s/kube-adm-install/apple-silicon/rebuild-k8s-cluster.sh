...
MASTER_MEMORY="2G"
WORKERS_MEMORY="8G"
LOCAL_VOLUMES_PATH="$HOME/mnt/k8s-volumes"
...
MKDIR_RESULT=$(mkdir -p "$LOCAL_VOLUMES_PATH")
CHMOD_RESULT=$(chmod 777 $LOCAL_VOLUMES_PATH)
echo -e "${BLUE}Results MKDIR_RESULT:$MKDIR_RESULT CHMOD_RESULT: $CHMOD_RESULT${NC}"
echo -e "${BLUE}Directory for host sharing volume data created at:$LOCAL_VOLUMES_PATH${NC}"
